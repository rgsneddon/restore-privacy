...
EXPECTED_RELEASE_PAGE = (
    "https://github.com/rgsneddon/restore-privacy/releases/tag/0.3.2"
)
EXPECTED_DOWNLOAD_PREFIX = (
    "https://github.com/rgsneddon/restore-privacy/releases/download/0.3.2/"
)
...
class TestDownloadCatalog(unittest.TestCase):
    ...
    def test_labels_and_html_paid(self):
        ...
        self.assertNotIn("releases/download/0.3.2/", html)
