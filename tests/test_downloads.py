...
EXPECTED_RELEASE_PAGE = (
    "https://github.com/rgsneddon/restore-privacy/releases/tag/0.4.5"
)
EXPECTED_DOWNLOAD_PREFIX = (
    "https://github.com/rgsneddon/restore-privacy/releases/download/0.4.5/"
)
...
class TestDownloadCatalog(unittest.TestCase):
    ...
    def test_payment_disclaimer_helper_exists_but_not_on_homepage_shop(self):
        ...
        css = download_css()
        # Pill buy controls (post-0.4.5 tidy: not fixed square tiles)
        self.assertTrue(
