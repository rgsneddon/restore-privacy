"""Catalog 0.3.5 packages must embed pin 0.3.5 (not stale 0.3.3/0.3.0)."""
...
@unittest.skipUnless(REL.is_dir(), "releases/0.3.5 not present")
class Test035PackagePins(unittest.TestCase):
    def test_macos_cfbundle_is_0_3_5(self):
    ...
    def test_ios_cfbundle_is_0_3_5(self):
    ...
    def test_android_version_name_is_0_3_5(self):
