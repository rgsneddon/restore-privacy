...
class TestFreeDownloadV1CtaAndPage(unittest.TestCase):
    ...
    def test_homepage_full_width_cta_above_stripe_selector(self) -> None:
        ...
        self.assertIn("@keyframes free-download-label-blink", cta_css)
        self.assertIn("animation:", cta_css)
        self.assertIn("infinite", cta_css)
        self.assertIn("prefers-reduced-motion", cta_css)
