...
class TestSuiteIntroRenderer(unittest.TestCase):
    def test_markup_order_and_copy(self) -> None:
        ...
        self.assertIn("your data is only retained by your own device.", html)
        self.assertIn("privacy, restored.", html)
        self.assertIn('id="suite-retention-type"', html)
        self.assertIn('data-typewriter-text="privacy, restored."', html)
    ...
    def test_homepage_path_includes_intro_and_script(self) -> None:
        ...
        self.assertIn("YOUR PRIVACY, RESTORED", page)
        self.assertIn("your data is only retained by your own device.", page)
        self.assertIn("privacy, restored.", page)
        ...
        i2 = page.index("suite-closing-type")
        i3 = page.index("suite-retention-type")
