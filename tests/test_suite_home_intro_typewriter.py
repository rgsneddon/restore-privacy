...
class TestSuiteIntroRenderer(unittest.TestCase):
    def test_markup_order_and_copy(self) -> None:
        ...
        self.assertNotIn("your data is only retained by your own device.", html)
        self.assertNotIn('id="suite-retention-type"', html)
        self.assertNotIn('id="suite-home-retention"', html)
    ...
    def test_homepage_path_includes_intro_and_script(self) -> None:
        ...
        self.assertIn("YOUR PRIVACY, RESTORED", page)
        self.assertNotIn("your data is only retained by your own device.", page)
        self.assertNotIn("suite-retention-type", page)
