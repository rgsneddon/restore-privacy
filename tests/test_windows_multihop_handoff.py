...
class TestWindowsMultihopHandoff(unittest.TestCase):
    def test_handoff_doc_exists_and_names_single_command(self):
        p = ROOT / "client" / "windows" / "WINDOWS_HANDOFF_0.4.0.md"
        self.assertTrue(p.is_file(), "missing WINDOWS_HANDOFF_0.4.0.md")
    ...
    def test_release_0_3_6_has_windows_only(self):
        src = (ROOT / "scripts" / "build_release_0.4.0.py").read_text(encoding="utf-8")
