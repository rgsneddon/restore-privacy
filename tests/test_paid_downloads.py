...
class TestPaidDownloadUI(unittest.TestCase):
    def test_buttons_are_paid_not_free_github_href(self):
        ...
        self.assertIn("Download client v0.3.8", html)
    ...
    def test_status_page_html_paid_flow(self):
        ...
        self.assertNotIn(
            'href="https://github.com/rgsneddon/restore-privacy/releases/download/0.3.8/restore-privacy-client-0.3.8-windows-x64-setup.exe"',
            page,
        )
...
class TestCheckoutAmount(unittest.TestCase):
    ...
    def test_checkout_form_body_includes_245_gbp_and_platform(self):
        ...
        self.assertEqual(
            ...
            ["restore-privacy-client-0.3.8-windows-x64-setup.exe"],
        )
        ...
        payload = json.dumps(
            {
                ...
                "data": {
                    "object": {
                        ...
                        "metadata": {
                            "platform": "ios",
                            "filename": "restore-privacy-client-0.3.8-ios.zip",
                            "amount_pence": "999",
                            "currency": "gbp",
                        },
                    }
...
class TestAdminAuth(unittest.TestCase):
    ...
    def test_admin_html_lists_grants_callable(self):
        ...
        payments.mint_download_token(
            filename="restore-privacy-client-0.3.8-macos.zip",
            platform="macos",
            session_id="cs_admin",
        )
...
class TestAdminHtmlArchitecture(unittest.TestCase):
    ...
    def test_authenticated_admin_has_settings_and_grants(self):
        payments.init_db()
        payments.mint_download_token(
            filename="restore-privacy-client-0.3.8-android.apk",
            platform="android",
...
class TestPrivateRepoProxyFulfilment(unittest.TestCase):
    ...
    def test_open_release_asset_from_local_dir(self):
        fname = "restore-privacy-client-0.3.8-linux-x64.tar.gz"
    ...
    def test_open_release_asset_github_api_sends_auth_header(self):
        fname = "restore-privacy-client-0.3.8-windows-x64-setup.exe"
        ...
        # Empty search dirs so we do not pick up real releases/0.3.8 on disk
        ...
        def fake_urlopen(req, timeout=None):
            ...
            # RELEASE_TAG pin is 0.3.8 (catalog monopin)
            if "/releases/tags/0.3.8" in url:
                body = json.dumps(
    ...
    def test_http_download_streams_not_redirects_to_github(self):
        ...
        fname = "restore-privacy-client-0.3.8-android.apk"
...
class TestGrantNotBurnedOnFulfilmentFail(unittest.TestCase):
    ...
    def test_http_502_leaves_token_reusable_then_success(self):
        ...
        fname = "restore-privacy-client-0.3.8-macos.zip"
        tok = payments.mint_download_token(
    ...
    def test_check_fulfilment_ready_local(self):
        fname = "restore-privacy-client-0.3.8-ios.zip"
...
class TestPostPaymentThankYouBuilder(unittest.TestCase):
    ...
    def test_builder_thankyou_admin_and_auto_start(self):
        ...
        self.assertIn("restore-privacy-client-0.3.8-windows-x64-setup.exe", html)
        ...
        with self.assertRaises(ValueError):
            payments.render_post_payment_thankyou_html(
                download_path=(
                    ...
                    "download/0.3.0/restore-privacy-client-0.3.8-windows-x64-setup.exe"
                ),
                filename="x.exe",
                platform="windows",
            )
