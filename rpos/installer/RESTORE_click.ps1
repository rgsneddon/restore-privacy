...
Write-Host "Launching GOD-aware RESTORE path (prefix=$Prefix)..."
...
Write-Host ""
Write-Host "GOD: personal setup — timezone, language, rpMail email."
python -m rpos.installer oobe --prefix $Prefix
Write-Host ""
Write-Host "GOD: locked guide — Pens, then Tables, then Slides."
