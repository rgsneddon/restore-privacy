...
ADMIN_ARCHITECTURE_BLURB = (
    ...
    "Germany (default entry) and Iceland — multi-hop opt-in uses the other peer. "
...
ADMIN_ARCHITECTURE_FULL = (
    ...
    "Residual entry is Germany by default, with Iceland as the other live peer. "
    ...
    "(Iceland, then Germany) under an exclusive lock so both never wipe together. "
