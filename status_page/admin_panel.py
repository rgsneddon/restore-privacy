...
ADMIN_ARCHITECTURE_FULL = (
    ...
    "exits through the other catalog peer rather than selling a second product. "
    "United States and Romania residual hosts stay retired.\n\n"
    ...
    "Link Generation, and durable licence history under Active Licences. That "
