...
Current ship: **0.3.7** under `0.3.7/`. Keep prior version dirs only if needed for rollback.

**0.3.7 staging:** Packages staged from `releases/0.3.7/` (Windows multihop PE
rebuilt on Windows host; Apple packages via Mac handoff
`client_app/APPLE_HANDOFF_0.3.7.md`; Android/Linux may carry-forward under
**0.3.7** filenames until native rebuild — see `releases/0.3.7/`). Node-only
