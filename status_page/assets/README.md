...
Current ship: **0.4.0** under `0.4.0/`. Keep prior version dirs only if needed for rollback.

**0.4.0 staging:** Packages staged from `releases/0.4.0/` (Windows multihop PE
rebuilt on Windows host; Apple packages via Mac handoff
`client_app/APPLE_HANDOFF_0.4.0.md`; Android/Linux may carry-forward under
**0.4.0** filenames until native rebuild — see `releases/0.4.0/`). Node-only
