...
Current ship: **0.3.8** under `0.3.8/`. Keep prior version dirs only if needed for rollback.

**0.3.8 staging:** Packages staged from `releases/0.3.8/` (Windows multihop PE
rebuilt on Windows host; Apple packages via Mac handoff
`client_app/APPLE_HANDOFF_0.3.8.md`; Android/Linux may carry-forward under
**0.3.8** filenames until native rebuild — see `releases/0.3.8/`). Node-only
