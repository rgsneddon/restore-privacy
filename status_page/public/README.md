...
| Platform | Package |
|----------|---------|
| Windows | `restore-privacy-client-0.5.0-windows-x64-setup.exe` |
| Android | `restore-privacy-client-0.5.0-android.apk` |
| macOS | `restore-privacy-client-0.5.0-macos.zip` *(**Developer ID signed + notarized** — see handoff)* |
| iOS | `restore-privacy-client-0.5.0-ios.zip` *(**Team-signed** sideload — see handoff)* |
| Ubuntu / Linux | `restore-privacy-client-0.5.0-linux-x64.tar.gz` |
...
Published **v0.5.0** macOS catalog zips are **Developer ID signed + notarized** (see `client_app/APPLE_HANDOFF_0.5.0.md`). Residual public-IP Connect on a developer Mac still needs Team residual re-sign for host NE.
