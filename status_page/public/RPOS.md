<!-- Source: https://github.com/rgsneddon/rpOS/blob/main/README.md -->

> **On this site:** rpOS documentation mirrored from the public [rpOS README](https://github.com/rgsneddon/rpOS/blob/main/README.md). That GitHub file remains the source of truth. Monorepo copy: `rpos/README.md`.
