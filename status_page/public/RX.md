...
1.1.9** native installers; it is not a replacement for residual TUN.
...
- **Not OS residual:** does **not** create Wintun / Packet Tunnel / system residual TUN. Native VPN clients (Windows · Android · macOS · iOS · Linux, catalog **1.1.9**) remain the residual product path.
