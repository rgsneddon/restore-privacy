...
| **Audit generated** | **4 August 2026** (`2026-08-04T23:04:23Z`) |
...
- Exit probe: **74 ms** via `tcp` (shared base for multi-hop rows).
...
|-------|------------|-----------|-------------------|------------------|-----|-----|-------|
| on | on | on | 55–60 ms (live base + shape feel) | 74–79 ms (live base + shape feel) | 67 ms | 🟧 | residual dials exit when multi-hop on; shape on adds modest jitter/cover feel; outer obfs on (QUIC-mimic, ~0 ms RTT); entry RTT live probe this host; exit RTT live probe this host; AVG 67.0 ms → amber |
...
| on | off | on | 55–60 ms (live base + shape feel) | 74–79 ms (live base + shape feel) | 67 ms | 🟧 | residual dials exit when multi-hop on; shape on adds modest jitter/cover feel; outer obfs off (bare RPT, ~0 ms RTT); entry RTT live probe this host; exit RTT live probe this host; AVG 67.0 ms → amber |
...
| off | on | on | 55 ms (live) | 74 ms (live) | 64.5 ms | 🟧 | residual dials exit when multi-hop on; shape off leaner; outer obfs on (QUIC-mimic, ~0 ms RTT); entry RTT live probe this host; exit RTT live probe this host; AVG 64.5 ms → amber |
...
| off | off | on | 55 ms (live) | 74 ms (live) | 64.5 ms | 🟧 | residual dials exit when multi-hop on; shape off leaner; outer obfs off (bare RPT, ~0 ms RTT); entry RTT live probe this host; exit RTT live probe this host; AVG 64.5 ms → amber |
...
|----------|---------|--------|
| **Info** | Automated pass at `2026-08-04T23:04:23Z` | Recorded |
