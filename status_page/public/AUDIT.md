...
| **Audit generated** | **4 August 2026** (`2026-08-04T19:24:05Z`) |
...
- Entry probe: **91 ms** via `tcp` (shared base across rows).
...
|-------|------------|-----------|-------------------|------------------|-----|-----|-------|
| on | on | on | 91–96 ms (live base + shape feel) | 77–82 ms (live base + shape feel) | 86.5 ms | 🟥 | residual dials exit when multi-hop on; shape on adds modest jitter/cover feel; outer obfs on (QUIC-mimic, ~0 ms RTT); entry RTT live probe this host; exit RTT live probe this host; AVG 86.5 ms → red |
| on | on | off | 91–96 ms (live base + shape feel) | n/a (multi-hop off) | 93.5 ms | 🟥 | single-hop residual → entry; shape on; outer obfs on (QUIC-mimic, ~0 ms RTT); entry RTT live probe this host; AVG 93.5 ms → red |
| on | off | on | 91–96 ms (live base + shape feel) | 77–82 ms (live base + shape feel) | 86.5 ms | 🟥 | residual dials exit when multi-hop on; shape on adds modest jitter/cover feel; outer obfs off (bare RPT, ~0 ms RTT); entry RTT live probe this host; exit RTT live probe this host; AVG 86.5 ms → red |
| on | off | off | 91–96 ms (live base + shape feel) | n/a (multi-hop off) | 93.5 ms | 🟥 | single-hop residual → entry; shape on; outer obfs off (bare RPT, ~0 ms RTT); entry RTT live probe this host; AVG 93.5 ms → red |
| off | on | on | 91 ms (live) | 77 ms (live) | 84 ms | 🟥 | residual dials exit when multi-hop on; shape off leaner; outer obfs on (QUIC-mimic, ~0 ms RTT); entry RTT live probe this host; exit RTT live probe this host; AVG 84.0 ms → red |
| off | on | off | 91 ms (live) | n/a (multi-hop off) | 91 ms | 🟥 | single-hop residual → entry; shape off (faster feel); outer obfs on (QUIC-mimic, ~0 ms RTT); entry RTT live probe this host; AVG 91.0 ms → red |
| off | off | on | 91 ms (live) | 77 ms (live) | 84 ms | 🟥 | residual dials exit when multi-hop on; shape off leaner; outer obfs off (bare RPT, ~0 ms RTT); entry RTT live probe this host; exit RTT live probe this host; AVG 84.0 ms → red |
| off | off | off | 91 ms (live) | n/a (multi-hop off) | 91 ms | 🟥 | single-hop residual → entry; shape off (faster feel); outer obfs off (bare RPT, ~0 ms RTT); entry RTT live probe this host; AVG 91.0 ms → red |
...
|----------|---------|--------|
| **Info** | Automated pass at `2026-08-04T19:24:05Z` | Recorded |
