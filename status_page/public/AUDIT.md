...
Last full RAG snapshot used catalog **v0.4.0** packages; live monopin is **0.4.7**.  
...
| Paid packages | `status_page/downloads.py` monopin **0.4.7** |
...
| Public catalog | **0.4.7** paid installers on [status host](https://restoreprivacy.online/) |
