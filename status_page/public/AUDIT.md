...
| **Audit generated** | **21 July 2026** (`2026-07-21T16:45:18Z`) |
...
|----------|---------|-------|-------|
| 🪟 **Windows** | `(missing windows)` | 🟥 | package file not found under releases/ or status_page/assets/ |
| 🐧 **Linux** | `(missing linux)` | 🟥 | package file not found under releases/ or status_page/assets/ |
| 🍎 **macOS** | `(missing macos)` | 🟥 | package file not found under releases/ or status_page/assets/ |
| 📱 **iOS** | `(missing ios)` | 🟥 | package file not found under releases/ or status_page/assets/ |
...
|----------|---------|--------|
| **Info** | Automated pass at `2026-07-21T16:45:18Z` | Recorded |
