...
| **Live probe peer** | **127.0.0.1:44044** (UDP); status UI TCP **8080** |
| **Audit generated** | **29 July 2026** (`2026-07-29T12:29:13Z`) |
...
## Installer package AUDIT STATE (catalog v0.5.3)
...
|----------|---------|-------|-------|
| 🪟 **Windows** | `restore-privacy-client-0.5.3-windows-x64-setup.exe` | 🟥 | catalog monopin asset not staged (looked for restore-privacy-client-0.5.3-windows-x64-setup.exe / relative_path 0.5.3/restore-privacy-client-0.5.3-windows-x64-setup.exe under status_page/assets/0.5.3/, releases/0.5.3/, paid_assets/0.5.3/, dist/0.5.3/, status_page/assets/; paid host may still fulfil via private GH / VPS HTTP when uploaded) |
| 🐧 **Linux** | `restore-privacy-client-0.5.3-linux-x64.tar.gz` | 🟥 | catalog monopin asset not staged (looked for restore-privacy-client-0.5.3-linux-x64.tar.gz / relative_path 0.5.3/restore-privacy-client-0.5.3-linux-x64.tar.gz under status_page/assets/0.5.3/, releases/0.5.3/, paid_assets/0.5.3/, dist/0.5.3/, status_page/assets/; paid host may still fulfil via private GH / VPS HTTP when uploaded) |
| 🍎 **macOS** | `restore-privacy-client-0.5.3-macos.zip` | 🟥 | catalog monopin asset not staged (looked for restore-privacy-client-0.5.3-macos.zip / relative_path 0.5.3/restore-privacy-client-0.5.3-macos.zip under status_page/assets/0.5.3/, releases/0.5.3/, paid_assets/0.5.3/, dist/0.5.3/, status_page/assets/; paid host may still fulfil via private GH / VPS HTTP when uploaded) |
| 📱 **iOS** | `restore-privacy-client-0.5.3-ios.zip` | 🟥 | catalog monopin asset not staged (looked for restore-privacy-client-0.5.3-ios.zip / relative_path 0.5.3/restore-privacy-client-0.5.3-ios.zip under status_page/assets/0.5.3/, releases/0.5.3/, paid_assets/0.5.3/, dist/0.5.3/, status_page/assets/; paid host may still fulfil via private GH / VPS HTTP when uploaded) |
| 🤖 **Android** | `restore-privacy-client-0.5.3-android.apk` | 🟥 | catalog monopin asset not staged (looked for restore-privacy-client-0.5.3-android.apk / relative_path 0.5.3/restore-privacy-client-0.5.3-android.apk under status_page/assets/0.5.3/, releases/0.5.3/, paid_assets/0.5.3/, dist/0.5.3/, status_page/assets/; paid host may still fulfil via private GH / VPS HTTP when uploaded) |
...
| **multihop_product_pubs** | **PASS** | IS pub present (/opt/restore-privacy/product/node_elgamal.pub) sha=1b126abfae737c66…; RO pub present (/opt/restore-privacy/product/exit_node_elgamal.pub) sha=a36a3f38066ece7b…; ... |
...
| Paid packages | `status_page/downloads.py` monopin **0.5.3**; assets under `status_page/assets/0.5.3/` + VPS `paid_assets` |
| Public web | `status_page/*` catalog **0.5.3** |
...
|----------|---------|--------|
| **Info** | Automated pass at `2026-07-29T12:29:13Z` | Recorded |
...
## 6. Automated checks (this pass — 29 July 2026)
...
| Public catalog | **0.5.3** paid installers on [status host](https://restoreprivacy.online/) (£2.45; no free GitHub release downloads) |
...
| Code baseline | Catalog **0.5.3** + node **127.0.0.1** |
| Pass date | **29 July 2026** |
