...
| **Production node** | **Iceland (IS):44044** (UDP); status UI TCP **8080** — **Iceland**, host **FlokiNET** |
| **Audit generated** | **26 July 2026** (`2026-07-26T23:31:29Z`) |
...
## Installer package AUDIT STATE (catalog v0.4.10)
...
|----------|---------|-------|-------|
| 🪟 **Windows** | `restore-privacy-client-0.4.10-windows-x64-setup.exe` | 🟥 | catalog monopin asset not staged (looked for restore-privacy-client-0.4.10-windows-x64-setup.exe / relative_path 0.4.10/restore-privacy-client-0.4.10-windows-x64-setup.exe under status_page/assets/0.4.10/, releases/0.4.10/, /opt/restore-privacy/paid_assets/0.4.10/, dist/0.4.10/, status_page/assets/; paid host may still fulfil via private GH / VPS HTTP when uploaded) |
| 🤖 **Android** | `restore-privacy-client-0.4.10-android.apk` | 🟥 | catalog monopin asset not staged (looked for restore-privacy-client-0.4.10-android.apk / relative_path 0.4.10/restore-privacy-client-0.4.10-android.apk under status_page/assets/0.4.10/, releases/0.4.10/, /opt/restore-privacy/paid_assets/0.4.10/, dist/0.4.10/, status_page/assets/; paid host may still fulfil via private GH / VPS HTTP when uploaded) |
| 🍎 **macOS** | `restore-privacy-client-0.4.10-macos.zip` | 🟥 | catalog monopin asset not staged (looked for restore-privacy-client-0.4.10-macos.zip / relative_path 0.4.10/restore-privacy-client-0.4.10-macos.zip under status_page/assets/0.4.10/, releases/0.4.10/, /opt/restore-privacy/paid_assets/0.4.10/, dist/0.4.10/, status_page/assets/; paid host may still fulfil via private GH / VPS HTTP when uploaded) |
| 📱 **iOS** | `restore-privacy-client-0.4.10-ios.zip` | 🟥 | catalog monopin asset not staged (looked for restore-privacy-client-0.4.10-ios.zip / relative_path 0.4.10/restore-privacy-client-0.4.10-ios.zip under status_page/assets/0.4.10/, releases/0.4.10/, /opt/restore-privacy/paid_assets/0.4.10/, dist/0.4.10/, status_page/assets/; paid host may still fulfil via private GH / VPS HTTP when uploaded) |
| 🐧 **Linux** | `restore-privacy-client-0.4.10-linux-x64.tar.gz` | 🟥 | catalog monopin asset not staged (looked for restore-privacy-client-0.4.10-linux-x64.tar.gz / relative_path 0.4.10/restore-privacy-client-0.4.10-linux-x64.tar.gz under status_page/assets/0.4.10/, releases/0.4.10/, /opt/restore-privacy/paid_assets/0.4.10/, dist/0.4.10/, status_page/assets/; paid host may still fulfil via private GH / VPS HTTP when uploaded) |
...
Latest automated security audit for production node **Iceland (IS)** and the in-repo privacy/security gates.
...
| Paid packages | `status_page/downloads.py` monopin **0.4.10**; assets under `status_page/assets/0.4.10/` + VPS `paid_assets` |
| Public web | `status_page/*` catalog **0.4.10** |
...
- Product default host **Iceland (IS)**.  
...
| Probe | Detail |
|-------|--------|
| TCP `Iceland (IS):8080` | ok=True error=None |
| HTTP `http://Iceland (IS):8080/status` | code=200 body={'title': 'RESTORE PRIVACY'} |
| UDP `Iceland (IS):44044` | sent=True error=None |
...
|----------|---------|--------|
| **Info** | Automated pass at `2026-07-26T23:31:29Z` | Recorded |
...
| Expectation | Notes |
|-------------|--------|
| Product host | **Iceland (IS)** |
| Public catalog | **0.4.10** paid installers on [status host](https://restoreprivacy.online/) (£2.45; no free GitHub release downloads) |
