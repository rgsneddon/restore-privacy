...
| **Audit generated** | **21 July 2026** (`2026-07-21T20:16:32Z`) |
...
|----------|---------|-------|-------|
| 🪟 **Windows** | `restore-privacy-client-0.3.6-windows-x64-setup.exe` | 🟧 | PE/MZ magic OK; node_elgamal.pub not found inside package (pin not verified) |
...
| 🤖 **Android** | `(missing android)` | 🟥 | package file not found under releases/ or status_page/assets/ |
...
|----------|---------|--------|
| **Info** | Automated pass at `2026-07-21T20:16:32Z` | Recorded |
