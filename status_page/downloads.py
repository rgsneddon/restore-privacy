"""Release download link catalog for the public status page (version 0.0.5).
...
# Canonical public asset filenames (must match releases/0.0.5/ and GitHub Release).
...
# Artifacts attached to GitHub Release 0.0.5
