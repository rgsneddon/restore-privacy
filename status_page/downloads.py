"""Release download catalog + paid download UI (version 0.5.6).
...
Current catalog packages: restore-privacy release **0.5.6**
(Windows setup needs no separate Python install; macOS/iOS may lag as
carry-forward until Apple seal lands; Android residual wire + US pin).
"""
