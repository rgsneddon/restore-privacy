"""Release download catalog + paid download UI (version 0.3.3).
...
Current catalog packages: restore-privacy release **0.3.3**
...
# Canonical public asset filenames (must match GitHub Release 0.3.3 assets).
