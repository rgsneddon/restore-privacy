"""Release download link catalog for the public status page (version 0.0.4).
...
# Canonical public asset filenames (must match releases/0.0.4/ and GitHub Release).
...
# Artifacts attached to GitHub Release 0.0.4
