"""Release download catalog + paid download UI (version 0.3.5).
...
Current catalog packages: restore-privacy release **0.3.5**
...
# Canonical public asset filenames (must match GitHub Release 0.3.5 assets).
...
# Compatibility aliases used by older tests (map to 0.3.5 installers).
