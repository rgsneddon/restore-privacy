/* Public /AUDIT.md page countdown ticker + last-run refresh. CSP: 'self' only. */
(function () {
  ...
  var lastRunEl = document.getElementById("audit-page-last-run-time");
  var helpers = globalThis.RptAuditLastRun || null;
  var pollEveryTicks = 60;
  var tickCount = 0;
