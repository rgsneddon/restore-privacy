...
| **Audit generated** | **21 July 2026** (`2026-07-21T21:50:49Z`) |
...
| 🤖 **Android** | `restore-privacy-client-0.3.6-android.apk` | 🟥 | catalog monopin asset not staged locally (looked for restore-privacy-client-0.3.6-android.apk under releases/0.3.6/ and status_page/assets/0.3.6/; paid host may still fulfil via private GH / VPS when uploaded) |
| 🍎 **macOS** | `restore-privacy-client-0.3.6-macos.zip` | 🟥 | catalog monopin asset not staged locally (looked for restore-privacy-client-0.3.6-macos.zip under releases/0.3.6/ and status_page/assets/0.3.6/; paid host may still fulfil via private GH / VPS when uploaded) |
| 📱 **iOS** | `restore-privacy-client-0.3.6-ios.zip` | 🟥 | catalog monopin asset not staged locally (looked for restore-privacy-client-0.3.6-ios.zip under releases/0.3.6/ and status_page/assets/0.3.6/; paid host may still fulfil via private GH / VPS when uploaded) |
| 🐧 **Linux** | `restore-privacy-client-0.3.6-linux-x64.tar.gz` | 🟥 | catalog monopin asset not staged locally (looked for restore-privacy-client-0.3.6-linux-x64.tar.gz under releases/0.3.6/ and status_page/assets/0.3.6/; paid host may still fulfil via private GH / VPS when uploaded) |
...
|----------|---------|--------|
| **Info** | Automated pass at `2026-07-21T21:50:49Z` | Recorded |
