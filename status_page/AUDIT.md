...
| **Audit generated** | **2 August 2026** (`2026-08-02T14:27:37Z`) |
...
- Entry probe: **52 ms** via `tcp` (shared base across rows).
- Exit probe: **64 ms** via `tcp` (shared base for multi-hop rows).
...
|-------|------------|-----------|-------------------|------------------|-----|-----|-------|
| on | on | on | 52–57 ms (live base + shape feel) | 64–69 ms (live base + shape feel) | 60.5 ms | 🟧 | residual dials exit when multi-hop on; shape on adds modest jitter/cover feel; outer obfs on (QUIC-mimic, ~0 ms RTT); entry RTT live probe this host; exit RTT live probe this host; AVG 60.5 ms → amber |
| on | on | off | 52–57 ms (live base + shape feel) | n/a (multi-hop off) | 54.5 ms | 🟧 | single-hop residual → entry; shape on; outer obfs on (QUIC-mimic, ~0 ms RTT); entry RTT live probe this host; AVG 54.5 ms → amber |
| on | off | on | 52–57 ms (live base + shape feel) | 64–69 ms (live base + shape feel) | 60.5 ms | 🟧 | residual dials exit when multi-hop on; shape on adds modest jitter/cover feel; outer obfs off (bare RPT, ~0 ms RTT); entry RTT live probe this host; exit RTT live probe this host; AVG 60.5 ms → amber |
| on | off | off | 52–57 ms (live base + shape feel) | n/a (multi-hop off) | 54.5 ms | 🟧 | single-hop residual → entry; shape on; outer obfs off (bare RPT, ~0 ms RTT); entry RTT live probe this host; AVG 54.5 ms → amber |
| off | on | on | 52 ms (live) | 64 ms (live) | 58 ms | 🟧 | residual dials exit when multi-hop on; shape off leaner; outer obfs on (QUIC-mimic, ~0 ms RTT); entry RTT live probe this host; exit RTT live probe this host; AVG 58.0 ms → amber |
| off | on | off | 52 ms (live) | n/a (multi-hop off) | 52 ms | 🟧 | single-hop residual → entry; shape off (faster feel); outer obfs on (QUIC-mimic, ~0 ms RTT); entry RTT live probe this host; AVG 52.0 ms → amber |
| off | off | on | 52 ms (live) | 64 ms (live) | 58 ms | 🟧 | residual dials exit when multi-hop on; shape off leaner; outer obfs off (bare RPT, ~0 ms RTT); entry RTT live probe this host; exit RTT live probe this host; AVG 58.0 ms → amber |
| off | off | off | 52 ms (live) | n/a (multi-hop off) | 52 ms | 🟧 | single-hop residual → entry; shape off (faster feel); outer obfs off (bare RPT, ~0 ms RTT); entry RTT live probe this host; AVG 52.0 ms → amber |
...
|----------|---------|--------|
| **Info** | Automated pass at `2026-08-02T14:27:37Z` | Recorded |
...
| Public catalog | **1.0.7** paid installers on [status host](https://restoreprivacy.online/) (£2.45; no free GitHub release downloads) |
