...
## Installer package AUDIT STATE (catalog v0.3.4)
...
|----------|---------|-------|-------|
| 🪟 **Windows** | `restore-privacy-client-0.3.4-windows-x64-setup.exe` | 🟩 | node_elgamal.pub pin matches product monopin; PE/MZ magic OK |
| 🐧 **Linux** | `restore-privacy-client-0.3.4-linux-x64.tar.gz` | 🟩 | node_elgamal.pub pin matches product monopin; archive present (structural residual gates N/A in this pass) |
| 🍎 **macOS** | `restore-privacy-client-0.3.4-macos.zip` | 🟩 | node_elgamal.pub pin matches product monopin; archive present (structural residual gates N/A in this pass) |
| 📱 **iOS** | `restore-privacy-client-0.3.4-ios.zip` | 🟩 | node_elgamal.pub pin matches product monopin; archive present (structural residual gates N/A in this pass) |
| 🤖 **Android** | `restore-privacy-client-0.3.4-android.apk` | 🟩 | node_elgamal.pub pin matches product monopin; Android residual wire (PFS + outer obfs) present |
...
| Public web | `status_page/*` catalog **0.3.4** |
...
|----------|---------|--------|
| **Info** | Automated pass at `2026-07-21T14:01:51Z` | Recorded |
...
| Code baseline | Catalog **0.3.4** + node **82.221.101.241** |
