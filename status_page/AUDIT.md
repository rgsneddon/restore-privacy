...
| **Audit generated** | **12 August 2026** (`2026-08-12T05:47:41Z`) |
...
- Entry probe: **53 ms** via `tcp` (shared base across rows).
...
|-------|------------|-----------|-------------------|------------------|-----|-----|-------|
| on | on | on | 53–58 ms (live base + shape feel) | 37–57 ms | 51.2 ms | 🟧 | residual dials exit when multi-hop on; shape on adds modest jitter/cover feel; outer obfs on (QUIC-mimic, ~0 ms RTT); entry RTT live probe this host; exit RTT approximate UK band; AVG 51.2 ms → amber |
| on | on | off | 53–58 ms (live base + shape feel) | n/a (multi-hop off) | 55.5 ms | 🟧 | single-hop residual → entry; shape on; outer obfs on (QUIC-mimic, ~0 ms RTT); entry RTT live probe this host; AVG 55.5 ms → amber |
| on | off | on | 53–58 ms (live base + shape feel) | 37–57 ms | 51.2 ms | 🟧 | residual dials exit when multi-hop on; shape on adds modest jitter/cover feel; outer obfs off (bare RPT, ~0 ms RTT); entry RTT live probe this host; exit RTT approximate UK band; AVG 51.2 ms → amber |
| on | off | off | 53–58 ms (live base + shape feel) | n/a (multi-hop off) | 55.5 ms | 🟧 | single-hop residual → entry; shape on; outer obfs off (bare RPT, ~0 ms RTT); entry RTT live probe this host; AVG 55.5 ms → amber |
| off | on | on | 53 ms (live) | 32–52 ms | 47.5 ms | 🟧 | residual dials exit when multi-hop on; shape off leaner; outer obfs on (QUIC-mimic, ~0 ms RTT); entry RTT live probe this host; exit RTT approximate UK band; AVG 47.5 ms → amber |
| off | on | off | 53 ms (live) | n/a (multi-hop off) | 53 ms | 🟧 | single-hop residual → entry; shape off (faster feel); outer obfs on (QUIC-mimic, ~0 ms RTT); entry RTT live probe this host; AVG 53.0 ms → amber |
| off | off | on | 53 ms (live) | 32–52 ms | 47.5 ms | 🟧 | residual dials exit when multi-hop on; shape off leaner; outer obfs off (bare RPT, ~0 ms RTT); entry RTT live probe this host; exit RTT approximate UK band; AVG 47.5 ms → amber |
| off | off | off | 53 ms (live) | n/a (multi-hop off) | 53 ms | 🟧 | single-hop residual → entry; shape off (faster feel); outer obfs off (bare RPT, ~0 ms RTT); entry RTT live probe this host; AVG 53.0 ms → amber |
...
|----------|---------|--------|
| **Info** | Automated pass at `2026-08-12T05:47:41Z` | Recorded |
