...
| Public web | `status_page/*` catalog **0.2.3** |
...
| Public catalog | **0.2.3** on [restore-privacy releases](https://github.com/rgsneddon/restore-privacy/releases) |
...
| Code baseline | Catalog **0.2.3** + node **82.221.101.241** |
