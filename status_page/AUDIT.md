...
## Installer package AUDIT STATE (last full RAG snapshot: catalog v0.4.0; live monopin **0.4.4**)
...
| Paid packages | `status_page/downloads.py` monopin **0.4.4**; assets under `status_page/assets/0.4.0/` + VPS `paid_assets` |
| Public web | `status_page/*` catalog **0.4.4** |
...
| Public catalog | **0.4.4** paid installers on [status host](https://restoreprivacy.online/) (£2.45; no free GitHub release downloads) |
