...
|----------|---------|-------------|-------|
| **Windows** | `restore-privacy-client-0.3.3-windows-x64-setup.exe` | **Green** | node_elgamal.pub pin matches product monopin; PE/MZ magic OK |
| **Linux** | `restore-privacy-client-0.3.3-linux-x64.tar.gz` | **Green** | node_elgamal.pub pin matches product monopin; archive present (structural residual gates N/A in this pass) |
| **macOS** | `restore-privacy-client-0.3.3-macos.zip` | **Green** | node_elgamal.pub pin matches product monopin; archive present (structural residual gates N/A in this pass) |
| **iOS** | `restore-privacy-client-0.3.3-ios.zip` | **Green** | node_elgamal.pub pin matches product monopin; archive present (structural residual gates N/A in this pass) |
| **Android** | `restore-privacy-client-0.3.3-android.apk` | **Green** | node_elgamal.pub pin matches product monopin; Android residual wire (PFS + outer obfs) present |

**Catalog overall (worst package):** **Green**
