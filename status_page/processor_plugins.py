...
STRIPE_PLUGIN = ProcessorPlugin(
    ...
    variables=(
        ...
        ProcessorVariable(
            ...
            label="Fulfilment SMTP host",
            purpose="SMTP server for customer email (keygen + PPI + download after pay)",
            required=False,
            secret=False,
            input_type="text",
        ...
        ProcessorVariable(
            ...
            label="Fulfilment SMTP port",
            purpose="SMTP port (default 587)",
            required=False,
            secret=False,
            input_type="text",
            placeholder="587",
        ...
        ProcessorVariable(
            ...
            label="Fulfilment SMTP user",
            purpose="SMTP username for fulfilment mail",
            required=False,
            secret=True,
            input_type="password",
        ...
        ProcessorVariable(
            ...
            label="Fulfilment SMTP password",
            purpose="SMTP password for fulfilment mail (never commit)",
            required=False,
            secret=True,
            input_type="password",
        ...
        ProcessorVariable(
            ...
            label="Fulfilment From email",
            purpose="From address for keygen fulfilment messages",
            required=False,
            secret=False,
            input_type="text",
            placeholder="noreply@restoreprivacy.online",
        ),
        ProcessorVariable(
            key="RPT_FULFILMENT_SMTP_TLS",
            label="Fulfilment SMTP TLS",
            purpose="1 = STARTTLS (default); 0 = disable",
            required=False,
            secret=False,
            input_type="text",
            placeholder="1",
