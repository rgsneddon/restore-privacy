# Windows brand breadcrumbs checklist — monopin 1.2.0
...
- **Native PE seal** for monopin **1.2.0** on this Windows machine (`scripts\\build_windows_multihop.py`).
- Upload sealed PE (+ brand packages as needed) to Helsinki `paid_assets/1.2.0/`.
...
Present on source host: **4** / 35  ·  Missing source: **31**  ·  Already on dest: **0**

## Brand inventory (all installer slots)

| Kind | Product | Platform | Filename | Source | Dest |
|------|---------|----------|----------|--------|------|
| suite_client | Restore Privacy Suite | windows | `restore-privacy-client-1.2.0-windows-x64-setup.exe` | MISSING | — |
| suite_client | Restore Privacy Suite | android | `restore-privacy-client-1.2.0-android.apk` | yes | — |
| suite_client | Restore Privacy Suite | macos | `restore-privacy-client-1.2.0-macos.zip` | yes | — |
| suite_client | Restore Privacy Suite | ios | `restore-privacy-client-1.2.0-ios.zip` | yes | — |
| suite_client | Restore Privacy Suite | linux | `restore-privacy-client-1.2.0-linux-x64.tar.gz` | yes | — |
| browser | Browser Extension (MV3) | chromium | `restore-privacy-browser-extension-1.2.0.zip` | MISSING | — |
| browser | Rx Privacy Browser | default | `restore-privacy-rx-browser-1.2.0.zip` | MISSING | — |
| browser | Rx Privacy Browser | macos | `restore-privacy-rx-browser-1.2.0-macos.zip` | MISSING | — |
| browser | Rx Privacy Browser | windows | `restore-privacy-rx-browser-1.2.0-windows.zip` | MISSING | — |
| browser | Rx Privacy Browser | linux-x86_64 | `restore-privacy-rx-browser-1.2.0-linux-x86_64.tar.gz` | MISSING | — |
| browser | Rx Privacy Browser | linux-aarch64 | `restore-privacy-rx-browser-1.2.0-linux-aarch64.tar.gz` | MISSING | — |
| browser | Rx Privacy Browser | linux-x86_64-zip | `restore-privacy-rx-browser-1.2.0-linux-x86_64.zip` | MISSING | — |
| browser | Rx Privacy Browser | ios | `restore-privacy-rx-browser-1.2.0-ios.zip` | MISSING | — |
| browser | Rx Privacy Browser | android | `restore-privacy-rx-browser-1.2.0-android.zip` | MISSING | — |
...
- Output: `releases/1.2.0/restore-privacy-client-1.2.0-windows-x64-setup.exe`
- Upload target: `paid_assets/1.2.0/`
...
python scripts\host_paid_assets_vps.py --stage --upload --version 1.2.0 --force --install-serve
```
...
- Helsinki breadcrumbs: dist/breadcrumbs/current/WINDOWS_HANDOFF.md (monopin 1.2.0).
