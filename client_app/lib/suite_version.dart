...
///
/// Catalog monopin **1.2.0** — dedicated residual VPN client (no multi-product
/// Suite chrome). Paid catalog / client [productVersion] pins must match.
library;

/// Catalog / pubspec monopin for the suite product.
const String kSuiteVersion = '1.2.0';

/// User-visible product family name.
const String kSuiteProductName = 'Restore Privacy residual VPN';

/// Canonical chrome / about / startup string: "Restore Privacy residual VPN v 1.2.0".
const String kSuiteDisplayVersion = 'Restore Privacy residual VPN v 1.2.0';
