...
///
/// Suite v1.1.0 unifies residual VPN, Perccent wallet (%), and Evolve under one
/// shell. Paid catalog / client [productVersion] pins must match this monopin.
library;

/// Catalog / pubspec monopin for the suite product.
const String kSuiteVersion = '1.1.0';

/// User-visible product family name.
const String kSuiteProductName = 'Restore Privacy Suite';

/// Canonical chrome / about / startup string: "Restore Privacy Suite v 1.1.0".
const String kSuiteDisplayVersion = 'Restore Privacy Suite v 1.1.0';
