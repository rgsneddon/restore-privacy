/// Full end-user licence (product LICENSE) for first-run scroll pane.
/// Keep in sync with monorepo root LICENSE / status_page/public/LICENSE.
library;

const String kFullEndUserLicenceText = r'''
RESTORE PRIVACY — PROPRIETARY FULL COPYRIGHT LICENCE
====================================================

Copyright (c) 2026 Raskul / Restore Privacy.
All rights reserved.
...
10. GENERAL
  ...
  Contact for licence questions: rus@restoreprivacy.online
