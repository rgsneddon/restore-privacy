# Mac / iOS handoff for Restore Privacy **0.1.8**
...
| File | Notes |
|------|--------|
| `restore-privacy-client-0.1.8-macos.zip` | Staged package for Mac work (may be prior-build payload renamed for catalog continuity) |
| `restore-privacy-client-0.1.8-ios.zip` | Staged sideload package (same) |
...
cd restore-privacy
git checkout 0.1.8   # or main after release
cd client_app
flutter pub get
# macOS
