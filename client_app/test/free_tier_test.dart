...
void main() {
  ...
  test('RptConfig paid productVersion is 0.4.7 catalog pin', () {
    expect(RptConfig.productVersion, '0.4.7');
    expect(RptConfig.displayProductVersion, freeAwareProductVersion('0.4.7'));
