...
**Residual public IP:** product “Connectedâ€ requires Packet Tunnel `.connected`. A host-side RPT2 HELLO alone is diagnostic (`ok: false`) and does **not** change your ISP egress IP — enable Network Extension signing/entitlements for full-system VPN.
...
Otherwise macOS shows: *Apple could not verify “restore_privacy_clientâ€ is free of malwareâ€¦*
