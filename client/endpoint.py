...
def product_sg_node_elgamal_pub_path() -> Path:
    """Public ElGamal pin for Singapore residual monopin."""
    return Path(__file__).resolve().parents[1] / "product" / "sg_node_elgamal.pub"
