...
class TunnelClientApp:
    ...
    def __init__(self) -> None:
        ...
        # Entry country (flags) — main shell above Connect
        ...
        self.country_frame = tk.Frame(self.bottom, bg=CHROME_BG)
        self.country_frame.pack(fill=tk.X, pady=(0, 2))
        tk.Label(
            self.country_frame,
            text="Entry country",
            bg=CHROME_BG,
        ...
        self._country_row = tk.Frame(self.country_frame, bg=CHROME_BG)
        self._country_row.pack(fill=tk.X, pady=(2, 0))
        ...
        self.country_menu.pack(fill=tk.X)
    ...
    def _open_settings(self) -> None:
        ...
        # CHECK BREADCRUMBS / residual push-receive removed — always off.
        ...
        def _save_prefs() -> None:
            ...
            note_var.set(
                ...
                f"Suite updates: manual free download only. "
            ...
            self._log(
                ...
                f"check_breadcrumbs=off (push-receive removed); "
        ...
        # CHECK BREADCRUMBS / residual push-receive removed — manual Suite update only.
        tk.Label(
            frm,
