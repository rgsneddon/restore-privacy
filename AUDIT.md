...
|----------|---------|-------|-------|
| 🪟 **Windows** | `restore-privacy-client-0.5.8-windows-x64-setup.exe` | 🟩 | present on Helsinki paid_assets store (https://135.181.152.10.sslip.io/paid-assets/0.5.8/restore-privacy-client-0.5.8-windows-x64-setup.exe; 38631642 bytes); structural pin/PE gates not re-scanned over HTTP (inventory presence from fulfilment host) |
...
| Public catalog | **0.5.8** paid installers on [status host](https://restoreprivacy.online/) (£3.00; no free GitHub release downloads) |
