...
| **Audit generated** | **29 July 2026** (`2026-07-29T12:37:55Z`) |
...
|----------|---------|-------|-------|
| 🪟 **Windows** | `restore-privacy-client-0.5.3-windows-x64-setup.exe` | 🟩 | present on Helsinki paid_assets store (https://135.181.152.10.sslip.io/paid-assets/0.5.3/restore-privacy-client-0.5.3-windows-x64-setup.exe; 38913402 bytes); structural pin/PE gates not re-scanned over HTTP (inventory presence from fulfilment host) |
| 🐧 **Linux** | `restore-privacy-client-0.5.3-linux-x64.tar.gz` | 🟩 | present on Helsinki paid_assets store (https://135.181.152.10.sslip.io/paid-assets/0.5.3/restore-privacy-client-0.5.3-linux-x64.tar.gz; 14407033 bytes); structural pin/PE gates not re-scanned over HTTP (inventory presence from fulfilment host) |
| 🍎 **macOS** | `restore-privacy-client-0.5.3-macos.zip` | 🟩 | present on Helsinki paid_assets store (https://135.181.152.10.sslip.io/paid-assets/0.5.3/restore-privacy-client-0.5.3-macos.zip; 20959489 bytes); structural pin/PE gates not re-scanned over HTTP (inventory presence from fulfilment host) |
| 📱 **iOS** | `restore-privacy-client-0.5.3-ios.zip` | 🟩 | present on Helsinki paid_assets store (https://135.181.152.10.sslip.io/paid-assets/0.5.3/restore-privacy-client-0.5.3-ios.zip; 9342563 bytes); structural pin/PE gates not re-scanned over HTTP (inventory presence from fulfilment host) |
| 🤖 **Android** | `restore-privacy-client-0.5.3-android.apk` | 🟩 | present on Helsinki paid_assets store (https://135.181.152.10.sslip.io/paid-assets/0.5.3/restore-privacy-client-0.5.3-android.apk; 52371453 bytes); structural pin/PE gates not re-scanned over HTTP (inventory presence from fulfilment host) |
...
|----------|---------|--------|
| **Info** | Automated pass at `2026-07-29T12:37:55Z` | Recorded |
