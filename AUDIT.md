...
| **Audit generated** | **21 July 2026** (`2026-07-21T22:09:00Z`) |
...
| 🤖 **Android** | `restore-privacy-client-0.3.6-android.apk` | 🟥 | catalog monopin asset not staged (looked for restore-privacy-client-0.3.6-android.apk / relative_path 0.3.6/restore-privacy-client-0.3.6-android.apk under status_page/assets/0.3.6/, releases/0.3.6/, /opt/restore-privacy/paid_assets/0.3.6/, dist/0.3.6/, status_page/assets/; paid host may still fulfil via private GH / VPS HTTP when uploaded) |
| 🍎 **macOS** | `restore-privacy-client-0.3.6-macos.zip` | 🟥 | catalog monopin asset not staged (looked for restore-privacy-client-0.3.6-macos.zip / relative_path 0.3.6/restore-privacy-client-0.3.6-macos.zip under status_page/assets/0.3.6/, releases/0.3.6/, /opt/restore-privacy/paid_assets/0.3.6/, dist/0.3.6/, status_page/assets/; paid host may still fulfil via private GH / VPS HTTP when uploaded) |
| 📱 **iOS** | `restore-privacy-client-0.3.6-ios.zip` | 🟥 | catalog monopin asset not staged (looked for restore-privacy-client-0.3.6-ios.zip / relative_path 0.3.6/restore-privacy-client-0.3.6-ios.zip under status_page/assets/0.3.6/, releases/0.3.6/, /opt/restore-privacy/paid_assets/0.3.6/, dist/0.3.6/, status_page/assets/; paid host may still fulfil via private GH / VPS HTTP when uploaded) |
| 🐧 **Linux** | `restore-privacy-client-0.3.6-linux-x64.tar.gz` | 🟥 | catalog monopin asset not staged (looked for restore-privacy-client-0.3.6-linux-x64.tar.gz / relative_path 0.3.6/restore-privacy-client-0.3.6-linux-x64.tar.gz under status_page/assets/0.3.6/, releases/0.3.6/, /opt/restore-privacy/paid_assets/0.3.6/, dist/0.3.6/, status_page/assets/; paid host may still fulfil via private GH / VPS HTTP when uploaded) |
...
| **disk_wipe_readiness** | **SKIP** | cryptsetup not found (FDE tooling absent); install_disk_encryption.sh present; install_zram_luks.sh present (node-only ram volume) |
| **ephemeral_dry_run** | **PASS** | ephemeral_node.py present; dry-run mode available; dry-run exit=0 |
...
|----------|---------|--------|
| **Info** | Automated pass at `2026-07-21T22:09:00Z` | Recorded |
...
| Code baseline | Catalog **0.3.6** + node **82.221.101.241** |
