...
|----------|---------|-------|-------|
| 🪟 **Windows** | `restore-privacy-client-1.0.0-windows-x64-setup.exe` | 🟩 | present on Helsinki paid_assets store (https://135.181.152.10.sslip.io/paid-assets/0.5.9/restore-privacy-client-1.0.0-windows-x64-setup.exe; 38631642 bytes); structural pin/PE gates not re-scanned over HTTP (inventory presence from fulfilment host) |
...
| Public web | `status_page/*` catalog **0.5.9** |
