#!/usr/bin/env python3
"""Build Restore Privacy Suite monopin 1.1.0 installers and stage for Helsinki.
...
are re-pinned to 1.1.0 for store layout; operators should replace with native
rebuilds when a Windows/Linux build agent is available.

Usage::

  python3 scripts/build_suite_1.1.0.py
  python3 scripts/build_suite_1.1.0.py --skip-build   # stage/copy only
  python3 scripts/build_suite_1.1.0.py --host-paid     # stage + Helsinki upload
"""
...
PRIOR_CANDIDATES = ("1.0.9", "1.0.8", "1.0.7", "1.0.6", "1.0.5", "1.0.4", "1.0.3", "1.0.2", "1.0.1", "1.0.0")
