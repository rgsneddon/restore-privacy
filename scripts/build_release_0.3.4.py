...
- Windows / Android / Linux: prefer local 0.3.0 assets renamed to 0.3.4 filenames
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument(
        "--with-carry-forward",
        action="store_true",
        help="Also stage Windows/Android/Linux from 0.3.0 under 0.3.4 names (default if not apple-only)",
    )
