#!/usr/bin/env python3
"""Build Restore Privacy client packages for release 0.0.6.
...
def build_android_apk() -> Path | None:
    """flutter build apk, or stage existing release APK under 0.0.6 name."""
    OUT.mkdir(parents=True, exist_ok=True)
    ...
    # Fallback: existing flutter-apk or previous release APK (rename to 0.0.6)
    candidates = [
