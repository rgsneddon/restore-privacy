#!/usr/bin/env python3
"""Build Restore Privacy residual VPN monopin 1.2.4 installers and stage for Helsinki.
...
Usage::
  ...
  python3 scripts/build_suite_1.2.4.py
  python3 scripts/build_suite_1.2.4.py --skip-build   # stage/copy only
  python3 scripts/build_suite_1.2.4.py --host-paid     # stage + Helsinki upload
"""
