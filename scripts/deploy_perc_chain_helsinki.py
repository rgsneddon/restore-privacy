...
Restore Privacy Suite v1.0.7 — evolve-perc-internet (Render) is **paused to
    ...
    env.write_text(
        "\n".join(
            [
                ...
                # none = solo Helsinki seed (do not re-attach paid Render dual-seed)
                "PERC_UPSTREAM_RENDEZVOUS_URL=none",
