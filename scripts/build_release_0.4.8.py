...
def main(argv: list[str] | None = None) -> int:
    ...
    manifest = {
        ...
        "notes": (
            "0.4.8: keygen paste/dismiss, Connect/Disconnect system VPN tandem, residual NE honesty; non-Apple CF from 0.4.7; Developer ID notarized macOS + iOS Team-signed sideload; "
