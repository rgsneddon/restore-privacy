...
def main(argv: list[str] | None = None) -> int:
    ...
    manifest = {
        ...
        "notes": (
            "0.4.8: live catalog Pay buttons + paid macOS fulfilment pin; residual/client carry from 0.3.4; connect pins production node Developer ID package seal + iOS Team-signed sideload; "
