...
- **Entry (Iceland):** `82.221.101.241:44044` — `product/node_elgamal.pub` (`1b126abfâ€¦`)
- **Exit (Romania):** `185.146.232.107:44044` — `product/exit_node_elgamal.pub` (`a36a3f38â€¦`, ElGamal **policy A**)
...
2. Multi-hop on **Linux 0.3.9**: `RPT_MULTIHOP_ENABLED=1` → residual via Romania  
3. Multi-hop on **Windows 0.3.9** (rebuilt PE): `RPT_MULTIHOP_ENABLED=1` → residual via Romania  
