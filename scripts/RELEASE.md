...
| Tag | Script |
|-----|--------|
| **0.2.3** | `scripts/build_release_0.2.3.py` |
...
Product node: **82.221.101.241:44044**. See `scripts/RELEASE_NOTES_0.2.3.md`.
...
# Confirm releases/0.2.3/ has windows + linux (+ android/apple if built)
# gh release create 0.2.3 with those files
```
