...
| Tag | Script |
|-----|--------|
| **0.2.2** | `scripts/build_release_0.2.2.py` |
...
Product node: **82.221.101.241:44044**. See `scripts/RELEASE_NOTES_0.2.2.md`.
...
# Confirm releases/0.2.2/ has windows + linux (+ android/apple if built)
# gh release create 0.2.2 with those files
```
