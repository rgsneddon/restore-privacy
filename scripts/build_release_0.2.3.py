...
def main() -> int:
    ...
    manifest = {
        ...
        "notes": (
            "0.2.3: Settings transparency, licence gate, aggregate monitoring, "
            "threat model docs, LUKS FDE, ephemeral nodes, native pad/obfs/PFS. "
            "0.2.2: traffic-shape default on, Settings legal links."
        ),
    }
