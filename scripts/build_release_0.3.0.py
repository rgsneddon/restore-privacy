#!/usr/bin/env python3
"""Build / stage Restore Privacy client packages for release 0.3.0.

Public GitHub Release **0.3.0** ships **Developer ID–notarized** macOS and
...
def main() -> int:
    ...
    manifest = {
        ...
        "notes": (
            "0.3.0: connect continuity (flyclient tip + Wintun settle poll); paid status admin; "
            "catalog from 0.2.9. Carries 0.2.9 tray/audit; 0.2.3 Settings/licence/pad/obfs/PFS."
        ),
    }
