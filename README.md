...
**Product ship (v0.5.7):** Paid installers on **[status downloads](https://restoreprivacy.online/)**. **macOS** native monopin **0.5.7** DevID+notarized (Team **SFCBP95595**); **iOS** Team-signed sideload — see `APPLE_HANDOFF_0.5.7.md`. **Android** and **Linux** native on this pin; **Windows** PE from Windows host (`WINDOWS_HANDOFF_0.5.7.md` + Helsinki breadcrumbs). Catalog residual peers: **IS** / **DE** (default) / **US** — Romania deprecated.
