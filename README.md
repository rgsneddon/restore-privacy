...
**Monopin 0.5.5 macOS is not on the paid store yet.** A Mac-native Developer ID + notarized seal is required (`client_app/APPLE_HANDOFF_0.5.5.md`, Helsinki breadcrumbs vault). Until that seal is published under `paid_assets/0.5.5/`, there is **no** live download — do not treat catalog filename alone as a sealed package.
