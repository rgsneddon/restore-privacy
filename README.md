...
| | |
|--|--|
| **Get the app** | [Download v0.1.0](https://github.com/rgsneddon/restore-privacy/releases/tag/0.1.0) · [Status & downloads](https://restore-privacy-status.onrender.com/) |
...
Download packages from the **[0.1.0 release](https://github.com/rgsneddon/restore-privacy/releases/tag/0.1.0)**  
or use the buttons on https://restore-privacy-status.onrender.com/

| Platform | Package |
|----------|---------|
| Windows | `restore-privacy-client-0.1.0-windows-x64-setup.exe` |
| Android | `restore-privacy-client-0.1.0-android.apk` |
| macOS | `restore-privacy-client-0.1.0-macos.zip` |
| iOS | `restore-privacy-client-0.1.0-ios.zip` |

### Windows

1. Download the **Windows installer (.exe)** from the release or status page.
2. Run **`restore-privacy-client-0.1.0-windows-x64-setup.exe`**.  
...
1. Download **`restore-privacy-client-0.1.0-macos.zip`** from the release or status page.
...
1. Download **`restore-privacy-client-0.1.0-ios.zip`** from the release or status page.
