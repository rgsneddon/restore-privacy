...
**Version v1.1.10** — monorepo for the free residual VPN client and operator tooling.
...
| Platform | File |
|----------|------|
| Windows | `restore-privacy-client-1.1.10-windows-x64-setup.exe` (native PE from Windows host) |
| Android | `restore-privacy-client-1.1.10-android.apk` |
| macOS | `restore-privacy-client-1.1.10-macos.zip` — Notarized Developer ID + residual Packet Tunnel **host NE** |
| iOS | `restore-privacy-client-1.1.10-ios.zip` — distribution / sideload |
| Linux | `restore-privacy-client-1.1.10-linux-x64.tar.gz` |

## Operator build

- Pin: `client/VERSION` → `1.1.10`
- Flutter client: `client_app/`
- Stage script: `scripts/build_suite_1.1.10.py` (this Mac host skips Windows CF)
