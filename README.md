...
| | |
|--|--|
| **Get the app** | [Status & paid downloads](https://restoreprivacy.online/) (catalog **v0.3.2**, £2.45 per package) |
...
**Current catalog (v0.3.2):** pay-per-package installers on https://restoreprivacy.online/ (£2.45 GBP via Stripe).  
...
| Platform | Package |
|----------|---------|
| Windows | `restore-privacy-client-0.3.2-windows-x64-setup.exe` |
| Android | `restore-privacy-client-0.3.2-android.apk` |
| macOS | `restore-privacy-client-0.3.2-macos.zip` *(Developer ID signed + notarized)* |
| iOS | `restore-privacy-client-0.3.2-ios.zip` *(Team-signed sideload)* |
| Ubuntu / Linux | `restore-privacy-client-0.3.2-linux-x64.tar.gz` |

### Windows

1. On the [status downloads page](https://restoreprivacy.online/), pay **£2.45** for **Windows** and download **`restore-privacy-client-0.3.2-windows-x64-setup.exe`** (one-time link after payment).
...
1. On the [status downloads page](https://restoreprivacy.online/), pay **£2.45** for **Android** and download **`restore-privacy-client-0.3.2-android.apk`** (one-time link after payment).
...
1. On the [status downloads page](https://restoreprivacy.online/), pay **£2.45** for **Linux** and download **`restore-privacy-client-0.3.2-linux-x64.tar.gz`** (one-time link after payment).
2. Unpack and run the bundled installer:
   ```bash
   tar xzf restore-privacy-client-0.3.2-linux-x64.tar.gz
...
1. On the [status downloads page](https://restoreprivacy.online/), pay **£2.45** for **macOS** and download **`restore-privacy-client-0.3.2-macos.zip`** (one-time link after payment).
...
1. On the [status downloads page](https://restoreprivacy.online/), pay **£2.45** for **iOS** and download **`restore-privacy-client-0.3.2-ios.zip`** (one-time link after payment).
...
- **Pay £2.45** buttons for Windows, Android, macOS, iOS, Linux — catalog **v0.3.2**  
...
**Product ship (v0.3.2):** Paid installers on **[status downloads](https://restoreprivacy.online/)** (macOS Developer ID notarized; iOS Team-signed). Source repo is private. Production node **82.221.101.241:44044**.
...
**Release scripts:** `scripts/build_release_0.3.2.py`. Apple handoff: [`client_app/APPLE_HANDOFF_0.3.0.md`](client_app/APPLE_HANDOFF_0.3.0.md). Release notes: [`scripts/RELEASE_NOTES_0.3.0.md`](scripts/RELEASE_NOTES_0.3.0.md).
...
python scripts/build_release_0.3.2.py
```
